...
button{{width:100%;height:44px;margin-top:22px;border:0;border-radius:6px;background:#16a99f;color:#fff;font-weight:750;cursor:pointer}}button:hover{{background:#19bdb1}}button:disabled{{opacity:.6;cursor:wait}}
